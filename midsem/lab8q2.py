...
if __name__ == "__main__":
    ...
    print("Inverted Index:", inverted_index)  # Debug print

    encrypted_index = encrypt_inverted_index(inverted_index, public_key)
    print("Encrypted Inverted Index:", encrypted_index)  # Debug print
    ...
    print("Decrypted Search Results:", results)  # Debug print
