...
# Create a counter with the specified nonce (64-bit block size for the counter part)
...
decrypt_ctr = Counter.new(64, prefix=nonce, initial_value=0)  # Use the same nonce
